...
export const BALANCE_CHECKPOINTS: Checkpoint[] = [
  { name: 'opening-expedition', scenario: { name: 'opening-expedition', version: SIMULATION_VERSION, seed: 7, durationMilliseconds: 20_000 }, count: 5, targets: { completionRate: { min: 0.5, max: 1 }, averageItems: { min: 1, max: 12 }, offlineAgreementRate: { min: 1, max: 1 } } },
  { name: 'early-progression', scenario: { name: 'early-progression', version: SIMULATION_VERSION, seed: 17, durationMilliseconds: 20_000, commands: [{ type: 'START_EXPEDITION' }, { type: 'ADVANCE_TIME', milliseconds: 20_000 }, { type: 'ADVANCE_TIME', milliseconds: 20_000 }, { type: 'ADVANCE_TIME', milliseconds: 20_000 }] }, count: 5, targets: { averageLevel: { min: 2, max: 5 }, inventoryPressure: { min: 0.8, max: 1 }, offlineAgreementRate: { min: 1, max: 1 } } },
  { name: 'next-area', scenario: { name: 'next-area', version: SIMULATION_VERSION, seed: 41, durationMilliseconds: 20_000, commands: [{ type: 'SET_AUTO_REPEAT', enabled: false }, { type: 'START_EXPEDITION' }, { type: 'ADVANCE_TIME', milliseconds: 20_000 }, { type: 'SELECT_AREA', areaId: 'moonlit-grove' }, { type: 'START_EXPEDITION' }] }, count: 3, requiredAreaId: 'moonlit-grove', targets: { completionRate: { min: 0.8, max: 1 }, offlineAgreementRate: { min: 1, max: 1 } } },
